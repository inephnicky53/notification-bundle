...
namespace Ineph\NotificationBundle\Model;
 ...
 *
 * @ORM\MappedSuperclass(repositoryClass="Ineph\NotificationBundle\Entity\Repository\NotificationRepository")
 * @package Ineph\NotificationBundle\Model
 */
abstract class Notification implements \JsonSerializable
{
     ...
     * @ORM\OneToMany(targetEntity="Ineph\NotificationBundle\Entity\NotifiableNotification", mappedBy="notification", cascade={"persist"})
     */
