 ...
 *
 * @ORM\Entity(repositoryClass="Ineph\NotificationBundle\Entity\Repository\NotifiableRepository")
...
class NotifiableEntity implements \JsonSerializable
{
     ...
     * @ORM\OneToMany(targetEntity="Ineph\NotificationBundle\Entity\NotifiableNotification", mappedBy="notifiableEntity",cascade={"persist"})
     */
