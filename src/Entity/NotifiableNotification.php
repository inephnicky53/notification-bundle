 ...
 *
 * @ORM\Entity(repositoryClass="Ineph\NotificationBundle\Entity\Repository\NotifiableNotificationRepository")
 *
 */
class NotifiableNotification implements \JsonSerializable
{
    ...
    /**
     * @var Notification
     * @ORM\ManyToOne(targetEntity="Ineph\NotificationBundle\Entity\Notification", inversedBy="notifiableNotifications", cascade={"persist"})
     */
    protected $notification;

    /**
     * @var NotifiableEntity
     * @ORM\ManyToOne(targetEntity="Ineph\NotificationBundle\Entity\NotifiableEntity", inversedBy="notifiableNotifications", cascade={"persist"})
     *
     */
